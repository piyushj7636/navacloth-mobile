...
const LimitedSeeAll = () => {
  ...
  const filtered = useMemo(() => {
    let data = products.filter((item) => item.tags?.includes("Limited"));
  ...
  const Header = React.memo(
    ({
      ...
      return (
        <View>
          <Text style={styles.headerText}>Limited</Text>
  ...
  return (
    <FlatList
      ...
      renderItem={({ item }) => (
        <TouchableOpacity
          onPress={() => router.push(`/(tabs)/home/limited/${item.id}`)}
          style={styles.card}
        >
...
export default React.memo(LimitedSeeAll);
