...
const NewArrivalsSeeAll = () => {
  ...
  const filtered = useMemo(() => {
    let data = products.filter((item) => item.tags?.includes("New Arrivals"));
  ...
  return (
    <FlatList
      ...
      renderItem={({ item }) => (
        <TouchableOpacity
          onPress={() => router.push(`/(tabs)/home/newarrivals/${item.id}`)}
          style={styles.card}
        >
...
export default React.memo(NewArrivalsSeeAll);
